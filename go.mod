...
replace github.com/iniwex5/swu-go => ./third_party/swu-go

replace github.com/emiago/sipgo => ./third_party/sipgo

replace github.com/1239t/swu-go => ./third_party/swu-go-1239

require (
	aead.dev/minisign v0.2.0 // indirect
	github.com/1239t/swu-go v0.0.1 // indirect
